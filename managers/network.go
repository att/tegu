...
func req_ep_list( rch chan *ipc.Chmsg, block bool ) ( map[string]*gizmos.Endpt ) {
	...
	//return gizmos.Epmap_from_ostack( req.Response_data.( map[string]*ostack.End_pt ) )
...
/*
	REVAMP: these maps should be deprecated.
...
---- */
	...
	//deprecated--- act_net = build( nil, sdn_host, cfg.max_link_cap, cfg.link_headroom, cfg.link_alarm_thresh, &empty_str )
...
///// fixme
					...
					case REQ_MAC2PHOST:
						...
						act_net.update_mac2phost( req.Req_data.( []string ), cfg.phost_suffix )
